...
if not NS then
   print("|cFFFF0000[Diddy AIO Caster]|r Core module not loaded!")
   return
end

-- Validate dependencies
if not NS.rotation_registry then
   print("|cFFFF0000[Diddy AIO Caster]|r Registry not found in Core!")
   return
end
...
print("|cFF00FF00[Diddy AIO Caster]|r 8 Caster strategies registered.")
