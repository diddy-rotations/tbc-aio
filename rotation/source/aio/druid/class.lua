...
Action[A.PlayerClass] = {
   ...
   HealingTouch13 = Create({ Type = "Spell", ID = 26979, Desc = "Healing Touch", isRank = 13 }),
   HealingTouch12 = Create({ Type = "Spell", ID = 26978, Desc = "Healing Touch", isRank = 12 }),
   HealingTouch11 = Create({ Type = "Spell", ID = 25297, Desc = "Healing Touch", isRank = 11 }),
   HealingTouch10 = Create({ Type = "Spell", ID = 9889, Desc = "Healing Touch", isRank = 10 }),
   HealingTouch9 = Create({ Type = "Spell", ID = 9888, Desc = "Healing Touch", isRank = 9 }),
   HealingTouch8 = Create({ Type = "Spell", ID = 9758, Desc = "Healing Touch", isRank = 8 }),
   HealingTouch7 = Create({ Type = "Spell", ID = 8903, Desc = "Healing Touch", isRank = 7 }),
   HealingTouch6 = Create({ Type = "Spell", ID = 6778, Desc = "Healing Touch", isRank = 6 }),
   HealingTouch5 = Create({ Type = "Spell", ID = 5189, Desc = "Healing Touch", isRank = 5 }),
   HealingTouch4 = Create({ Type = "Spell", ID = 5188, Desc = "Healing Touch", isRank = 4 }),
   HealingTouch3 = Create({ Type = "Spell", ID = 5187, Desc = "Healing Touch", isRank = 3 }),
   HealingTouch2 = Create({ Type = "Spell", ID = 5186, Desc = "Healing Touch", isRank = 2 }),
   HealingTouch1 = Create({ Type = "Spell", ID = 5185, Desc = "Healing Touch", isRank = 1 }),

   -- Regrowth ranks (10 total)
   Regrowth10 = Create({ Type = "Spell", ID = 26980, Desc = "Regrowth", isRank = 10 }),
   Regrowth9 = Create({ Type = "Spell", ID = 9858, Desc = "Regrowth", isRank = 9 }),
   Regrowth8 = Create({ Type = "Spell", ID = 9857, Desc = "Regrowth", isRank = 8 }),
   Regrowth7 = Create({ Type = "Spell", ID = 9856, Desc = "Regrowth", isRank = 7 }),
   Regrowth6 = Create({ Type = "Spell", ID = 9750, Desc = "Regrowth", isRank = 6 }),
   Regrowth5 = Create({ Type = "Spell", ID = 8941, Desc = "Regrowth", isRank = 5 }),
   Regrowth4 = Create({ Type = "Spell", ID = 8940, Desc = "Regrowth", isRank = 4 }),
   Regrowth3 = Create({ Type = "Spell", ID = 8939, Desc = "Regrowth", isRank = 3 }),
   Regrowth2 = Create({ Type = "Spell", ID = 8938, Desc = "Regrowth", isRank = 2 }),
   Regrowth1 = Create({ Type = "Spell", ID = 8936, Desc = "Regrowth", isRank = 1 }),

   -- Rejuvenation ranks (13 total)
   Rejuvenation13 = Create({ Type = "Spell", ID = 26982, Desc = "Rejuvenation", isRank = 13 }),
   Rejuvenation12 = Create({ Type = "Spell", ID = 26981, Desc = "Rejuvenation", isRank = 12 }),
   Rejuvenation11 = Create({ Type = "Spell", ID = 25299, Desc = "Rejuvenation", isRank = 11 }),
   Rejuvenation10 = Create({ Type = "Spell", ID = 9841, Desc = "Rejuvenation", isRank = 10 }),
   Rejuvenation9 = Create({ Type = "Spell", ID = 9840, Desc = "Rejuvenation", isRank = 9 }),
   Rejuvenation8 = Create({ Type = "Spell", ID = 9839, Desc = "Rejuvenation", isRank = 8 }),
   Rejuvenation7 = Create({ Type = "Spell", ID = 8910, Desc = "Rejuvenation", isRank = 7 }),
   Rejuvenation6 = Create({ Type = "Spell", ID = 3627, Desc = "Rejuvenation", isRank = 6 }),
   Rejuvenation5 = Create({ Type = "Spell", ID = 2091, Desc = "Rejuvenation", isRank = 5 }),
   Rejuvenation4 = Create({ Type = "Spell", ID = 2090, Desc = "Rejuvenation", isRank = 4 }),
   Rejuvenation3 = Create({ Type = "Spell", ID = 1430, Desc = "Rejuvenation", isRank = 3 }),
   Rejuvenation2 = Create({ Type = "Spell", ID = 1058, Desc = "Rejuvenation", isRank = 2 }),
   Rejuvenation1 = Create({ Type = "Spell", ID = 774, Desc = "Rejuvenation", isRank = 1 }),

   -- Self-cast healing ranks
   SelfHealingTouch13 = Create({ Type = "Spell", ID = 26979, Desc = "Self Healing Touch", isRank = 13, Click = { unit = "player" } }),
   SelfHealingTouch12 = Create({ Type = "Spell", ID = 26978, Desc = "Self Healing Touch", isRank = 12, Click = { unit = "player" } }),
   SelfHealingTouch11 = Create({ Type = "Spell", ID = 25297, Desc = "Self Healing Touch", isRank = 11, Click = { unit = "player" } }),
   SelfHealingTouch10 = Create({ Type = "Spell", ID = 9889, Desc = "Self Healing Touch", isRank = 10, Click = { unit = "player" } }),
   SelfHealingTouch9 = Create({ Type = "Spell", ID = 9888, Desc = "Self Healing Touch", isRank = 9, Click = { unit = "player" } }),
   SelfHealingTouch8 = Create({ Type = "Spell", ID = 9758, Desc = "Self Healing Touch", isRank = 8, Click = { unit = "player" } }),
   SelfHealingTouch7 = Create({ Type = "Spell", ID = 8903, Desc = "Self Healing Touch", isRank = 7, Click = { unit = "player" } }),
   SelfHealingTouch6 = Create({ Type = "Spell", ID = 6778, Desc = "Self Healing Touch", isRank = 6, Click = { unit = "player" } }),
   SelfHealingTouch5 = Create({ Type = "Spell", ID = 5189, Desc = "Self Healing Touch", isRank = 5, Click = { unit = "player" } }),
   SelfHealingTouch4 = Create({ Type = "Spell", ID = 5188, Desc = "Self Healing Touch", isRank = 4, Click = { unit = "player" } }),
   SelfHealingTouch3 = Create({ Type = "Spell", ID = 5187, Desc = "Self Healing Touch", isRank = 3, Click = { unit = "player" } }),
   SelfHealingTouch2 = Create({ Type = "Spell", ID = 5186, Desc = "Self Healing Touch", isRank = 2, Click = { unit = "player" } }),
   SelfHealingTouch1 = Create({ Type = "Spell", ID = 5185, Desc = "Self Healing Touch", isRank = 1, Click = { unit = "player" } }),

   SelfRegrowth10 = Create({ Type = "Spell", ID = 26980, Desc = "Self Regrowth", isRank = 10, Click = { unit = "player" } }),
   SelfRegrowth9 = Create({ Type = "Spell", ID = 9858, Desc = "Self Regrowth", isRank = 9, Click = { unit = "player" } }),
   SelfRegrowth8 = Create({ Type = "Spell", ID = 9857, Desc = "Self Regrowth", isRank = 8, Click = { unit = "player" } }),
   SelfRegrowth7 = Create({ Type = "Spell", ID = 9856, Desc = "Self Regrowth", isRank = 7, Click = { unit = "player" } }),
   SelfRegrowth6 = Create({ Type = "Spell", ID = 9750, Desc = "Self Regrowth", isRank = 6, Click = { unit = "player" } }),
   SelfRegrowth5 = Create({ Type = "Spell", ID = 8941, Desc = "Self Regrowth", isRank = 5, Click = { unit = "player" } }),
   SelfRegrowth4 = Create({ Type = "Spell", ID = 8940, Desc = "Self Regrowth", isRank = 4, Click = { unit = "player" } }),
   SelfRegrowth3 = Create({ Type = "Spell", ID = 8939, Desc = "Self Regrowth", isRank = 3, Click = { unit = "player" } }),
   SelfRegrowth2 = Create({ Type = "Spell", ID = 8938, Desc = "Self Regrowth", isRank = 2, Click = { unit = "player" } }),
   SelfRegrowth1 = Create({ Type = "Spell", ID = 8936, Desc = "Self Regrowth", isRank = 1, Click = { unit = "player" } }),

   SelfRejuvenation13 = Create({ Type = "Spell", ID = 26982, Desc = "Self Rejuvenation", isRank = 13, Click = { unit = "player" } }),
   SelfRejuvenation12 = Create({ Type = "Spell", ID = 26981, Desc = "Self Rejuvenation", isRank = 12, Click = { unit = "player" } }),
   SelfRejuvenation11 = Create({ Type = "Spell", ID = 25299, Desc = "Self Rejuvenation", isRank = 11, Click = { unit = "player" } }),
   SelfRejuvenation10 = Create({ Type = "Spell", ID = 9841, Desc = "Self Rejuvenation", isRank = 10, Click = { unit = "player" } }),
   SelfRejuvenation9 = Create({ Type = "Spell", ID = 9840, Desc = "Self Rejuvenation", isRank = 9, Click = { unit = "player" } }),
   SelfRejuvenation8 = Create({ Type = "Spell", ID = 9839, Desc = "Self Rejuvenation", isRank = 8, Click = { unit = "player" } }),
   SelfRejuvenation7 = Create({ Type = "Spell", ID = 8910, Desc = "Self Rejuvenation", isRank = 7, Click = { unit = "player" } }),
   SelfRejuvenation6 = Create({ Type = "Spell", ID = 3627, Desc = "Self Rejuvenation", isRank = 6, Click = { unit = "player" } }),
   SelfRejuvenation5 = Create({ Type = "Spell", ID = 2091, Desc = "Self Rejuvenation", isRank = 5, Click = { unit = "player" } }),
   SelfRejuvenation4 = Create({ Type = "Spell", ID = 2090, Desc = "Self Rejuvenation", isRank = 4, Click = { unit = "player" } }),
   SelfRejuvenation3 = Create({ Type = "Spell", ID = 1430, Desc = "Self Rejuvenation", isRank = 3, Click = { unit = "player" } }),
   SelfRejuvenation2 = Create({ Type = "Spell", ID = 1058, Desc = "Self Rejuvenation", isRank = 2, Click = { unit = "player" } }),
   SelfRejuvenation1 = Create({ Type = "Spell", ID = 774, Desc = "Self Rejuvenation", isRank = 1, Click = { unit = "player" } }),
